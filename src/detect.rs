...
///
/// The sections omh ships are the base set's, not detection's — they are its
/// opinion, versioned and cost-measured like every other entry. This assembles
/// them; it no longer holds them.
